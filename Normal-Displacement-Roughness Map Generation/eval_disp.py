...
#%%
PATH_CHK = "./disp/disp_net_epoch_100.pth"
DIR_EVAL = "./textures/"
...
def test(net, in_folder, out_folder):
    ...
    with torch.no_grad():
        for idx, data in enumerate(testloader):
            ...
            img_out_filename = os.path.join(output_normal, f"{data[1][0]}_displacement.png")
...
def main():
    ...
    # test_folder = os.path.join(DIR_EVAL, "displacement")
