...
roughness_dir = os.path.join(DIR_OUT, "roughness")
        ...
        try:
            with ZipFile(os.path.join(DIR_IN, zip_name), "r") as z:
                ...
                if 0 not in checklist:
                    ...
                    z.extract(rough_file, roughness_dir)
                    os.replace(os.path.join(roughness_dir, rough_file), os.path.join(roughness_dir, filename) + ".jpg")
