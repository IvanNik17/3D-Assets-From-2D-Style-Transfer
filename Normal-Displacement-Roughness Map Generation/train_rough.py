        ...
        if (epoch+1) % PARAMS["valid"]["log_interv"] == 0 or epoch == 0:
            with torch.no_grad():
                ...
                torch.save({
                    ...
                    }, os.path.join(CHK_OUT, f"roughness_net_epoch_{epoch+1:03}.pth"))
...
def main():
    ...
    disp_folder = os.path.join(DIR_TRAIN, "roughness")
    ...
    test_disp_folder = os.path.join(DIR_TEST, "output_rough")
    valid_folder = os.path.join(DIR_VALID, "rough")
